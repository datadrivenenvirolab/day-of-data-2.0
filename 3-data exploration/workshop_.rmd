...
*Sunny September is when people ride the most bikes*

## group_by() + summarize()

*What is the average median Weather?*
```{r}
df %>%
  group_by(month) %>%
  summarize(med_temp = median(tmax)) %>%
  arrange(desc(med_temp))
```
*July has a beautiful 85 F (29 C)*
